...
For the configuration of each type, please see its [Type Definition](https://github.com/big-camel/am-editor/blob/master/packages/engine/src/types/toolbar.ts)
