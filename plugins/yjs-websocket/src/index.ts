...
import * as syncProtocol from '@aomao/plugin-yjs-protocols/dist/sync';
import * as authProtocol from '@aomao/plugin-yjs-protocols/dist/auth';
import * as awarenessProtocol from '@aomao/plugin-yjs-protocols/dist/awareness';
...
messageHandlers[messageSync] = (
	...
	const syncMessageType = readSyncMetaMessage(
		decoder,
		encoder,
		provider.doc,
		provider,
