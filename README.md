...
<p align="center">
  <a href="https://github.com/itellyou-com/am-editor/blob/master/README.zh-CN.md"><strong>中文</strong></a> ·
...
`Vue3` case [https://github.com/itellyou-com/am-editor/tree/master/examples/vue](https://github.com/itellyou-com/am-editor/tree/master/ examples/vue)

`React` case [https://github.com/itellyou-com/am-editor/tree/master/examples/react](https://github.com/itellyou-com/am-editor/tree/master/ examples/react)
...
Each editor acts as a [client](https://github.com/itellyou-com/am-editor/tree/master/examples/react/components/editor/ot/client.ts) through `WebSocket` and [ Server](https://github.com/itellyou-com/am-editor/tree/master/ot-server) Communication and exchange of data in `json0` format generated by the editor.
...
Before enabling collaborative editing, we need to configure [client](https://github.com/itellyou-com/am-editor/tree/master/examples/react/components/editor/ot/client.ts) and [Server](https://github.com/itellyou-com/am-editor/tree/master/ot-server)
...
[View the complete React example](https://github.com/itellyou-com/am-editor/tree/master/examples/react)

[View the complete example of Vue3](https://github.com/itellyou-com/am-editor/tree/master/examples/vue)
